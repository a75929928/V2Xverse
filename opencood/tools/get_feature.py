...
def train_parser():
    ...
    parser.add_argument('--save_path', default="",
                        help='where to save the generated feature')
...
def main():
    ...
    saved_path = os.path.join(saved_path, 'dict_size%d' % (hypes['model']['args']['codebook']['dict_size']))
    '''
    ...
    for i, batch_data in enumerate(train_loader):
        ...
        save_path = os.path.join(save_path, '%d_%d' % (hypes['model']['args']['codebook']['seg_num'], hypes['model']['args']['codebook']['dict_size']))    
        print("batchdata", i)
